...
<head>
    ...
    <style>
        :root {
            ...
            --secondary: #ec4899; --accent: #06b6d4; --bg-dark: #0a0a0a;
            --card-bg: rgba(20, 20, 20, 0.6); --glass: rgba(255, 255, 255, 0.03);
            --border: 1px solid rgba(255, 255, 255, 0.08); --text-main: #ffffff; --text-muted: #a3a3a3;
        }
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Outfit', sans-serif; scroll-behavior: smooth; }
        ...
        .logo { font-size: 1.8rem; font-weight: 800; letter-spacing: -1px; } .logo span { color: var(--primary); }
...
<body>
    ...
    <section id="home" class="hero">
        <div class="hero-content">
            ...
            <p style="color: var(--text-muted); line-height: 1.7; margin-bottom: 40px; max-width: 550px;"><?php echo $settings['bio']; ?></p>
            <div class="hero-buttons">
                <a href="#projects" class="btn-primary" style="text-decoration:none;">View My Work</a>
                <a href="<?php echo $settings['github_link']; ?>" target="_blank" class="btn-outline" style="text-decoration:none;">GitHub Profile</a>
            </div>
        </div>
        ...
        <div class="project-grid">
            ...
            while($row = mysqli_fetch_assoc($res)): ?>
                <div class="project-card">
                    ...
                    <p style="color: var(--text-muted); line-height: 1.6; margin: 15px 0;"><?php echo $row['description']; ?></p>
                    <div class="tags">
