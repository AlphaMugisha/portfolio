<?php
// --- PHP CONTACT FORM LOGIC ---
$message_sent = false;
if (isset($_POST['email']) && $_POST['email'] != '') {
    if (filter_var($_POST['email'], FILTER_VALIDATE_EMAIL)) {
        // In a real server, you'd use mail(), but for localhost testing:
        $userName = $_POST['name'];
        $userEmail = $_POST['email'];
        $messageSubject = "New Portfolio Inquiry";
    ...
    <section id="projects" class="section">
        ...
        <div class="project-grid">
            <div class="project-card">
                <div class="p-icon"><ion-icon name="alarm-outline"></ion-icon></div>
                <h3>TimeSuite Alarm</h3>
                <p>A smart alarm system designed for heavy sleepers. It features a "Lockdown Mode" requiring math problems.</p>
                <div class="tags">
                    <span class="tag">PHP</span><span class="tag">MySQL</span><span class="tag">JS</span>
                </div>
                <a href="https://github.com/AlphaMugisha/online-alarm-system" target="_blank" class="p-link">View Code <ion-icon name="arrow-forward"></ion-icon></a>
            </div>
            </div>
    </section>
